from agents import Agent, WebSearchTool, function_tool, RunContextWrapper, ModelSettings, Runner, ItemHelpers
...
plot_agent = Agent[UserContext](
    ...
    instructions=f"""{RECOMMENDED_PROMPT_PREFIX}
        ...
        1. Think carefully about the most appropriate chart type.
